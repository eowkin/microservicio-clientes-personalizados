package com.bancoexterior.parametros.clientes.model;
...
public class RegistrarAuditoriaRequest {
	...
	public RegistrarAuditoriaRequest(ClientesPersonalizadosRequestCrear request, String microservicio,HttpServletRequest requestHTTP) {
