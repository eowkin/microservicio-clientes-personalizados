...
@Data
public class ClientesPersonalizadosRequestCrear implements Serializable{
	...
	@Valid
	private ClientesPersonalizadosDtoRequestCrear clientesPersonalizadosDtoRequestCrear;
	
	public ClientesPersonalizadosRequestCrear() {
		super();
		this.clientesPersonalizadosDtoRequestCrear = new ClientesPersonalizadosDtoRequestCrear();
	}
